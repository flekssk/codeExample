...
namespace TeachersTrainingCenterBundle\Feature\CourseGroup\Http\UpdateCourseGroup\Api\v1\Output;
...
/** @psalm-immutable */
class UpdateCourseGroupResponse extends ConventionalApiResponseDTO
{
    /**
     * @var CourseDTO[]
     *
