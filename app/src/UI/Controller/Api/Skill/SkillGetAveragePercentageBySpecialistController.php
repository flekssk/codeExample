...
/**
 * Class SkillGetAveragePercentageBySpecialistController.
 *
 * @package App\UI\Controller\Api\Skill
 */
class SkillGetAveragePercentageBySpecialistController extends AbstractController
{
    /**
     * @var SkillGetService
     */
     ...
     * @SWG\Tag(
     *     name="Skill",
     *     description="Получение среднего процента по ключевым навыкам для определенного специалиста."
     * )
     *
     * @SWG\Parameter(
     *     in="query",
     ...
     * ),
     *
     * @Route("api/v1/specialist-skill-average-percentage_get-by-specialist-id", methods={"GET"})
     *
    ...
    public function __invoke(Request $request)
    {
        ...
        try {
            $result = $this->skillGetService->getKeySkillsAveragePercentageBySpecialistId(
                (int) $request->get('id'),
            );
